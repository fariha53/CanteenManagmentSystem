...
class Main
{
    public Main()
    {
        JFrame f= new JFrame("Canteen");
        f.setLayout(new FlowLayout(FlowLayout.LEADING,20,20));
        f.setSize(450,450);
        f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        Font myFont = new Font("Arial",Font.BOLD,25);

        ImageIcon im = new ImageIcon("C:\\Users\\ASUS\\IdeaProjects\\CanteenManagementSystem\\picture\\first.jpg");
        f.setIconImage(im.getImage());
        f.getContentPane().setBackground(Color.PINK);

        JFrame frme = new JFrame("Employee Info");
        frme.setLayout(new FlowLayout(FlowLayout.CENTER,20,20));
        frme.setSize(500,600);
        ...
        JDialog jd = new JDialog(f,"Manage your canteen",false);
        jd.setLayout(new FlowLayout(FlowLayout.LEADING,50,50));
        jd.setSize(800,600);

        JDialog rd = new JDialog(f,"Registration form",false);
        ...
        ImageIcon bill = new ImageIcon("C:\\Users\\ASUS\\IdeaProjects\\CanteenManagementSystem\\picture\\billing.jpg");
        ImageIcon inv = new ImageIcon("C:\\Users\\ASUS\\IdeaProjects\\CanteenManagementSystem\\picture\\inventory.png");
        ImageIcon supp = new ImageIcon("C:\\Users\\ASUS\\IdeaProjects\\CanteenManagementSystem\\picture\\supply.png");
        ImageIcon empl = new ImageIcon("C:\\Users\\ASUS\\IdeaProjects\\CanteenManagementSystem\\picture\\employee.png");
        ...
        String pro_cha[]={"Burgers","HotDogs","Pastas","Specials","Desserts","Pizza","Drinks"};
        JComboBox jcb_p = new JComboBox(pro_cha);
        ...
        JDialog error = new JDialog(f,"ERROR",false);
        ...
        String pro_sup[]={"Pran Group","Ispahani","PNS Group","HRC","BD Foods Limited"};
        JComboBox jcb2 = new JComboBox(pro_sup);
        s_del.add(jcb2);
        s_del.add(sb_del);
        ...
        String pro[]={"Burgers","HotDogs","Pastas","Specials","Desserts","Pizza","Drinks"};
        JComboBox jcb4 = new JComboBox(pro);
        jcb4.setBounds(50, 50,90,20);
        pro_del.add(jcb4);
        pro_del.add(pr_del);
        ...
        String ep [] ={"Rahim","Karim","Kamal","Jamal","Rafiq","peter","parker"};
        JComboBox jcb3 = new JComboBox(ep);
        emp_del.add(jcb3);
        emp_del.add(ep_del);
        ...
        invt.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae){
                ...
                try{
                    ...
                    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/Canteen","root",""); //PRODUCT
        ...
        sup.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae){
                ...
                try{
                    Class.forName("com.mysql.jdbc.Driver");
                    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/canteen","root",""); //EMPLOYEE
                    Statement st = con.createStatement();
        ...
        ep_del.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                try{
                    ...
                    Class.forName("com.mysql.jdbc.Driver");
                    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/canteen","root",""); //DEL INSIDE DIALOG
                    Statement st = con.createStatement();
        ...
        bl.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                try{
                    Class.forName("com.mysql.jdbc.Driver");
                    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/canteen","root","pandu1089");
                    Statement st = con.createStatement();
        ...
        pr_del.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                try{
                    ...
                    Class.forName("com.mysql.jdbc.Driver");
                    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/canteen","root","pandu1089"); //DEL INSIDE P_DIALOG
                    Statement st = con.createStatement();
